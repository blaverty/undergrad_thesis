...
/usr/local/blast/current/bin/blastn -query ~/sepsis2/AMR4/$1 -out ~/sepsis2/AMR4/BandS/$2 -db nt -qcov_hsp_perc 70 -outfmt "6 qseqid saccver qstart qend sstart send length qcovs staxid ssciname evalue"
#wait
